...
import 'package:naemen/Components/check_appointment.dart';
import 'package:naemen/Components/text_heading.dart';
import 'package:naemen/Screens/booking_detail_page.dart';
            ...
            TextButton(
              ...
              child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        child: Center(
                                          child: TextHeading(title: "Okey", fontweight: FontWeight.w400, fontsize: 12.sp, fontcolor: Colors.white),
                                        ),
                                    ),
            ),
          ],
              ...
              children: [
               ...
               width: 340.w,
                 ...
                 child: Row(
                   ...
                   children: [
                     TextHeading(title: "1 Service added", fontweight: FontWeight.w600, fontsize: 14.sp, fontcolor: Colors.white),
                     InkWell(
                       onTap: (){
                         _checkArtistAvailability();
                        // Navigator.push(context, MaterialPageRoute(builder: (context)=>AppointmentScreen()));
                       },
                       child: _isLoading?CircularProgressIndicator(color: Colors.orange,):
                       Container(
                         height: 32.h,
                         width: 148.w,
                         decoration: BoxDecoration(
                         ...
                         child: Row(
                           ...
                           children: [
                             TextHeading(title: "Book appointment", fontweight: FontWeight.w600, fontsize: 12.sp, fontcolor: Colors.white),
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Image.asset("assets/images/masseag.png",),
                            SizedBox(width: 10.w,),
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                TextHeading(title: "Body Massage", fontweight: FontWeight.w400, fontsize: 16.sp, fontcolor: Colors.white),
                                SizedBox(height: 5.h,),
                                TextHeading(title: "51", fontweight: FontWeight.w600, fontsize: 18.sp, fontcolor: Colors.white),
                                SizedBox(height: 5.h,),
                    ...
                    Positioned(
                      bottom: 10,right: 5,
                        child: CircleAvatar(
                          ...
                          radius: 15,backgroundColor: Colors.yellow.withOpacity(0.6),))
                  ],
                ),
                SizedBox(height: 20.h,),
                Stack(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),image: DecorationImage(image: AssetImage("assets/images/beard_cut_img.jpeg"),fit:BoxFit.cover)),
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                TextHeading(title: "Beard Cut", fontweight: FontWeight.w400, fontsize: 16.sp, fontcolor: Colors.white),
                                SizedBox(height: 5.h,),
                                TextHeading(title: "50", fontweight: FontWeight.w600, fontsize: 20.sp, fontcolor: Colors.white),
                                SizedBox(height: 5.h,),
                              //  TextHeading(title: "Lorem Ipsum is simply dummy text of the\n printing and more", fontweight: FontWeight.w400, fontsize: 8.sp, fontcolor: Colors.white)
                              ],
                            ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),image: DecorationImage(image: AssetImage("assets/images/hair_men cut.jpg"),fit:BoxFit.cover)),
                           ...
                           // Image.asset("assets/images/hair_men cut.jpg",width: 90,),
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                TextHeading(title: "Hair Cut", fontweight: FontWeight.w400, fontsize: 16.sp, fontcolor: Colors.white),
                                SizedBox(height: 5.h,),
                                TextHeading(title: "55", fontweight: FontWeight.w600, fontsize: 20.sp, fontcolor: Colors.white),
                                SizedBox(height: 5.h,),
                             //   TextHeading(title: "Lorem Ipsum is simply dummy text of the\n printing and more", fontweight: FontWeight.w400, fontsize: 8.sp, fontcolor: Colors.white)
                              ],
                            ),
